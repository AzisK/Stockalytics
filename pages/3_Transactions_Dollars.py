...
if selected_ticker == 'All Ticker':
    # profit_total_usd = profit_total['Currency'] == 'USD'
    cols = ['Buy Total Amount', 'Sell Total Amount', 'Profit', 'Total Fees', 'Unsold Amount', 'Unsold Profit']
    # profit_total.loc[profit_total_usd, cols] = profit_total[profit_total_usd][cols] * get_current_price('USDEUR=X')
